...
# * SPEED: The horizontal speed at which the player moves.
# * JUMP_VELOCITY: The velocity applied when the player jumps (negative value for upward movement).
# */
...
#/**
# * gravity: The gravity value applied to the player, retrieved from the project settings.
# */
var gravity = ProjectSettings.get_setting("physics/2d/default_gravity")

# Node references
#/**
# * animated_sprite: Reference to the player's AnimatedSprite2D node for animation control.
# */
@onready var animated_sprite = $AnimatedSprite2D

# Player state variables
#/**
# * is_hurt: Tracks whether the player is currently hurt.
# * is_dead: Tracks whether the player is dead.
# * jump_count: Tracks the number of jumps the player has made.
# */
...
#/**
# * hurt: Marks the player as hurt, plays the hurt animation, and resets the hurt state after a delay.
# */
func hurt():
...
#/**
# * _on_player_dead: Marks the player as dead, plays the death animation, and reloads the scene after a delay.
# */
...
#/**
# * _physics_process: Handles player movement, gravity, jumping, and animation.
# * If the player is hurt or dead, movement is halted.
# */
